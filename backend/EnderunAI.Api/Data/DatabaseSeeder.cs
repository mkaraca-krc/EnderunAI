...
public static class DatabaseSeeder
{
        ...
        RolIzinFarkiniHesaplaAsync(AppDbContext db)
    {
        ...
        return (eklenecek, silinecek, mevcut.Count, elleEklemeTablosuVar, katalogCiftleri.Count);
    }
    ...
    {
        var (eklenecek, silinecek, _, elleEklemeTablosuVar, _) =
