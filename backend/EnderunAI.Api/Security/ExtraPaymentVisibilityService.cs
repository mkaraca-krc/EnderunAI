...
///
/// <see cref="ISalaryVisibilityService"/> ile aynı desen ama AYRI kapı:
/// bordroyu yöneten (salary.view) herkes elden ödemeleri görmez.
/// Şantiye Şefi, Formen, Teknik Ofis ve Sekreterya hiçbir koşulda
/// göremez.
///
