...
type Line = { materialDescription:string; quantity:string; unit:string; requestedDeliveryDate:string; notes:string; position:SelectedPosition|null };
const emptyLine = (): Line => ({ materialDescription:"", quantity:"", unit:"Adet", requestedDeliveryDate:"", notes:"", position:null });
